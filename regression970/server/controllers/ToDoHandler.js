...
function create(req, res) {
    logger.log("info", "POST request received " + req.body.task_name);
...
function update(req, res) {
    logger.log("info", "PUT request received " + req.params._id + "\n" + req.body.task_name);
    if (req.body.task_name) {
...
function remove(req, res) {
    logger.log("info", "DELETE request received " + req.params._id);
